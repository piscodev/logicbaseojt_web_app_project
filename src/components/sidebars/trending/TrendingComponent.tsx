                ...
                trendingTopics.map((topic, index) => (
                    <li key={index} aria-labelledby={`trending-topic-${index}`} className="flex space-x-3 py-4">
                        ...
                        <div className="min-w-0 flex-1">
                            <p className="text-sm">{topic.content.length >= 50 ? topic.content.slice(0, 50) : topic.content}</p>
                            <div className="mt-2 flex">
                                <span className="inline-flex items-center text-sm">
                                    <button type="button" className="inline-flex space-x-2 text-gray-600 hover:text-gray-500">
                                        ...
                                        <span className="font-medium">{topic.comment_count}</span>
                                    </button>
                                </span>
                            </div>
                        </div>
