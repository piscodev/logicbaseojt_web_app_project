            ...
            {/* <div> */}
                ...
                <aside className="block lg:hidden mx-auto sm:px-9 p-3 pt-5">
                    <div className="rounded-lg shadow p-3">
                        <h2 id="who-to-follow-heading" className="text-base font-medium">Recommendations</h2>
                        <Suspense fallback={<div className="flex justify-center"><CircularProgress /></div>}>
                ...
                <div className="p-3 py-10">
                    <div className="mx-auto max-w-3xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-12 lg:gap-8 lg:px-8">
                        <div className="hidden lg:col-span-3 lg:block xl:col-span-2">
                            <nav aria-label="Sidebar" className="sticky top-[90px] divide-y">
                                <div className="space-y-1 pb-5">
                                    <a href="#" className="hover:bg-[#006aff] bg-gray-50 text-gray-800 group flex items-center px-3 py-2 text-sm font-medium rounded-md" aria-current="page">
                                        <svg className="text-[#006aff] group-hover:text-[#12c1eb] flex-shrink-0 -ml-1 mr-3 h-6 w-6" x-description="Heroicon name: outline/home" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true">
                                    ...
                                    <a href="#" className="hover:bg-[#006aff] group flex items-center px-3 py-2 text-sm font-medium rounded-md" x-state-description="undefined: &quot;bg-gray-200 text-gray-900&quot;, undefined: &quot;text-gray-700 hover:bg-gray-50&quot;">
                                        <svg className="text-[#006aff] group-hover:text-[#12c1eb] flex-shrink-0 -ml-1 mr-3 h-6 w-6" x-description="Heroicon name: outline/fire" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true">
                                    ...
                                    <a href="#" className="hover:bg-[#006aff] group flex items-center px-3 py-2 text-sm font-medium rounded-md" x-state-description="undefined: &quot;bg-gray-200 text-gray-900&quot;, undefined: &quot;text-gray-700 hover:bg-gray-50&quot;">
                                        <svg className="text-[#006aff] group-hover:text-[#12c1eb] flex-shrink-0 -ml-1 mr-3 h-6 w-6" x-description="Heroicon name: outline/user-group" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true">
                                    ...
                                    <a href="#" className="hover:bg-[#006aff] group flex items-center px-3 py-2 text-sm font-medium rounded-md" x-state-description="undefined: &quot;bg-gray-200 text-gray-900&quot;, undefined: &quot;text-gray-700 hover:bg-gray-50&quot;">
                                        <svg className="text-[#006aff] group-hover:text-[#12c1eb] flex-shrink-0 -ml-1 mr-3 h-6 w-6" x-description="Heroicon name: outline/arrow-trending-up" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true">
                        ...
                        <aside className="hidden xl:col-span-4 xl:block">
                            <div className="sticky top-[90px] space-y-4">
                                ...
                                <section aria-labelledby="trending-heading">
                                    <Box sx={{ color: 'text.secondary'}}>
                                        <Card variant="outlined">
                                            <h2 id="trending-heading" className="text-base font-medium">Trending</h2>
                                            <div className="mt-6 flow-root">
                                                <ul role="list" className="-my-4 divide-y">
                                                    <CardContent>
                                                        <Typography
